...
namespace Api.Controllers
{
    ...
    public class FriendController : ControllerBase
    {
        ...
        public async Task<ActionResult<FriendShipDto>> AcceptFriendRequest(string requestId)
        {
            ...
            var friendship = await _friendService.AcceptFriendRequestAsync(requestId);
        ...
        {
            var deleted = await _friendService.DeleteFriendRequestAsync(requestId);
        ...
        public async Task<ActionResult<IEnumerable<FriendRequestDto>>> GetFriendRequests(string userId)
        {
